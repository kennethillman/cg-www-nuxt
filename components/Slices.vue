<template>
    <div class="container">
        ...
        <!-- Case / Article -->
            ...
            <!-- cg-content-image -->
            <template v-if="slice.slice_type === 'cg-content-image'">
        ...
        <!-- Expertise -->
            ...
            <!-- cg-expertise-list -->
            <template v-if="slice.slice_type === 'cg-expertise-list'">
        ...
        <!-- Startpage -->
            ...
            <!-- cg-clients -->
            <template v-if="slice.slice_type === 'cg-clients'">
                <cg-clients :slice="slice"/>
            </template>
