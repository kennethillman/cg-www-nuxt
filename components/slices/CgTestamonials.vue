<template>
  <section class="cg-testamonials">
    <div class="site-content-width">
      ...
      <hooper class="hopper-animated-slide" :settings="hooperSettingsAnimated" :infiniteScroll="false"  :transition="1000" @afterSlide="evAfter" @slide="evSlide"
          :class="[{'is-sliding' : this.noTrans}]" >
